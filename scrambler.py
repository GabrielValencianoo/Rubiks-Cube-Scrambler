...
def estatistica():
    ...
    print("melhor: ",global_best_solve)
    print("pior:", global_worst_solve)
    print("media: ",media)
    print("mo3: " ,media_3)
    print("ao5: ",media_5)
    print("ao12: ",media_12)
    print("PB ao3: ",best_mo3)
    print("PB ao5: ",best_ao5)
    print("PB ao12: ",best_ao12)
...
def on_press_space(event):
    ...
    if _short_press is None: # only set timer if a key press is not ongoing
        ...
        _short_press = True
        _do_space_longpress = root.after(1000, do_space_longpress)
